...
const certificateMap = {
  ...
  'CIS_HR': 'asset/hrsd.png',
  'CIS_DF': 'asset/DF.png',
  'Zurich-CSA': 'asset/Zurich-CSA.png',
  'Zurich-CAD': 'asset/Zurich-CAD.png',
  'Zurich-ITSM': 'asset/Zurich-ITSM.png',
  ...
  'DeloitteAppreciate2025': 'asset/deloitte-appreciation.png',
  'DeloitteApplause2026': 'asset/Deloitte.Applause2026.png',
};
...
document.addEventListener('DOMContentLoaded', function() {
  document.querySelectorAll('.awards-grid .cert-card').forEach(card => {
    if (card.querySelector('.award-card-video')) {
      return;
    }

    const video = document.createElement('video');
    video.className = 'award-card-video';
    video.autoplay = true;
    video.muted = true;
    video.loop = true;
    ...
    source.src = 'asset/sec-awards.mp4';
